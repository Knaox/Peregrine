...
// has passed. Every five minutes so suspension lands close to the period end
// (the query is a cheap indexed lookup, no-op when nothing is due). The
// deletion happens later via PurgeScheduledServerDeletionsJob.
