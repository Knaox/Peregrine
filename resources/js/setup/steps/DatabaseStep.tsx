    ...
    return (
        <div className="space-y-6">
            ...
            {dockerDetected && dbReady && (
                <div className="flex items-start gap-3 p-4 bg-[var(--color-success)]/10 border border-[var(--color-success)]/30 rounded-[var(--radius)]">
                    <svg className="w-5 h-5 text-[var(--color-success)] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {dockerDetected && !dbReady && (
                <div className="flex items-start gap-3 p-4 bg-[var(--color-info)]/10 border border-[var(--color-info)]/30 rounded-[var(--radius)]">
                    <svg className="w-5 h-5 text-[var(--color-info)] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
