...
/**
 * Button uses the global `scale-on-hover` class so the
 * `theme_hover_scale` Refinement (subtle / default / pronounced) is
 * actually felt on press. The CSS rule lives in `app.css` and reads
 * `var(--hover-scale)`.
 */
export function Button({
    ...
    return (
        <button
            ...
            onClick={onClick}
            className={clsx(
                'scale-on-hover rounded-[var(--radius)] font-medium cursor-pointer',
