...
const colorConfig: Record<NonNullable<BadgeProps['color']>, ColorConfig> = {
    ...
    yellow: {
        ...
        glow: 'shadow-[0_0_8px_rgba(var(--color-warning-rgb),0.5)]',
        pulse: false,
    },
    red: {
    ...
    gray: {
        badge: 'bg-[var(--color-text-muted)]/10 text-[var(--color-text-secondary)] border border-[var(--color-text-muted)]/20',
        dot: 'bg-[var(--color-text-muted)]',
        glow: '',
        pulse: false,
    },
    orange: {
        badge: 'bg-[var(--color-primary)]/10 text-[var(--color-primary-hover)] border border-[var(--color-primary)]/20',
    ...
    blue: {
        ...
        glow: 'shadow-[0_0_8px_rgba(var(--color-info-rgb),0.5)]',
        pulse: false,
    },
};
