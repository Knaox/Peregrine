...
const ICON: Record<AuthProviderId, string> = {
    ...
    // WHMCS — receipt + dollar mark, generic billing system glyph (their
    // brand mark is a logo file, not a single-path icon). Admins who want
    // the official mark upload it via "Custom button logo" in /admin/auth-settings.
    whmcs: 'M5 3a2 2 0 00-2 2v15.5a.5.5 0 00.8.4L7 18.5l3.2 2.4a.5.5 0 00.6 0L14 18.5l3.2 2.4a.5.5 0 00.8-.4V5a2 2 0 00-2-2H5zm2 4h10v2H7V7zm0 4h10v2H7v-2zm0 4h6v2H7v-2z',
};
