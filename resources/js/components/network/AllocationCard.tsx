                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            {alloc.is_default && (
                                <span className="inline-flex items-center gap-1 rounded-[var(--radius)] bg-[var(--color-primary)]/15 px-2 py-1 text-xs font-semibold text-[var(--color-primary)]">
                                    ...
                                    {t('server-network:network.primary')}
                                </span>
                            )}
                        </div>
                        {editingNotes && canUpdate ? (
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    placeholder={t('server-network:network.notes_placeholder')}
                            ...
                            >
                                ...
                                {alloc.notes || t('server-network:network.notes')}
                            </button>
                        ) : alloc.notes ? (
