        ...
        <div className="flex h-screen items-center justify-center bg-[var(--color-background)] px-4 text-[var(--color-text-primary)]">
            <div className="max-w-md text-center space-y-3">
                <h1 className="text-lg font-semibold">
                    {t('theme-studio:error.title', 'Theme Studio could not load')}
                </h1>
                <p className="text-sm text-[var(--color-text-muted)]">
                    {t('theme-studio:error.body',
                ...
                <div className="flex justify-center gap-2 pt-2">
                    ...
                    >
                        {t('theme-studio:error.back', 'Back to dashboard')}
                    </Link>
                    <Button variant="primary" size="sm" onClick={onRetry}>
                        {t('theme-studio:error.retry', 'Retry')}
                    </Button>
                </div>
            </div>
        </div>
