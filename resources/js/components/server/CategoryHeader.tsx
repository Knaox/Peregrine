...
export function CategoryHeader({
    ...
    const handleDelete = useCallback(() => {
        const confirmed = window.confirm(t('server-overview:list.delete_category_confirm'));
        ...
        >
            ...
            <div className="flex items-center gap-1">
                ...
                <button
                    ...
                    className="group/btn flex h-7 w-7 items-center justify-center rounded-[var(--radius-sm)] cursor-pointer opacity-50 hover:opacity-100 hover:bg-[rgba(var(--color-primary-rgb),0.1)] transition-all"
                    title={t('common:edit')}
                >
                    <svg className="h-3.5 w-3.5 text-[var(--color-text-secondary)] group-hover/btn:text-[var(--color-primary)] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <button
                    ...
                    className="group/btn flex h-7 w-7 items-center justify-center rounded-[var(--radius-sm)] cursor-pointer opacity-50 hover:opacity-100 hover:bg-[rgba(var(--color-danger-rgb),0.12)] transition-all"
                    title={t('common:delete')}
                >
                    <svg className="h-3.5 w-3.5 text-[var(--color-text-secondary)] group-hover/btn:text-[var(--color-danger)] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
