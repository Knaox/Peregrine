...
export function AddCategoryButton({ onCreate }: AddCategoryButtonProps) {
    ...
    return (
        <button
            ...
            className="flex items-center gap-2 w-full glass-card-enhanced rounded-[var(--radius-lg)] px-4 py-3 cursor-pointer text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] hover:border-[rgba(var(--color-primary-rgb),0.4)] transition-all duration-200"
        >
