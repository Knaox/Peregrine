        ...
        <AnimatePresence>
            {selectedCount > 0 && (
                <m.div
                    ...
                    className="fixed bottom-0 left-0 right-0 z-50 backdrop-blur-xl bg-[var(--color-glass)] border-t border-[var(--color-glass-border)] shadow-[0_-8px_30px_rgba(0,0,0,0.5)] px-3 sm:px-6 py-3"
                >
