...
@if($official)
    <div style="
        ...
        background: linear-gradient(135deg, rgba(var(--primary-500),0.18), rgba(var(--primary-500),0.06));
        border: 1px solid rgba(var(--primary-500),0.22);
        box-shadow: 0 0 18px rgba(var(--primary-500),0.18);
        display: flex; align-items: center; justify-content: center;
        overflow: hidden;
    " aria-label="Peregrine official">
...
@else
    ...
    " aria-label="Community plugin">
        <svg style="width: 22px; height: 22px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
