...
class EggResource extends Resource
{
    ...
    {
        return __('admin/eggs.resource.navigation');
    }

    public static function getModelLabel(): string
    {
        return __('admin/eggs.resource.label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin/eggs.resource.plural');
    }
            ...
            ->schema([
                Section::make(__('admin/eggs.sections.metadata'))
                    ...
                    ->schema([
                        ...
                        Textarea::make('description')->label(__('admin/_shell.fields.description'))->disabled()->rows(3),
                        TextInput::make('docker_image')->label(__('admin/_shell.fields.docker_image'))->disabled(),
                    ]),
                Section::make(__('admin/eggs.sections.local'))
                    ...
                    ->schema([
                        FileUpload::make('banner_image')
                            ->label(__('admin/_shell.fields.banner_image'))
                            ->image()
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('pelican_egg_id')
                    ->label(__('admin/_shell.fields.pelican_egg_id'))
                    ->sortable(),
                ...
                Tables\Columns\TextColumn::make('nest.name')
                    ->label(__('admin/_shell.fields.nest'))
                    ->searchable()
                    ->sortable(),
                Tables\Columns\TextColumn::make('docker_image')
                    ->label(__('admin/_shell.fields.docker_image'))
                    ->searchable()
                    ->limit(40)
            ...
            ->emptyStateHeading(__('admin/eggs.resource.plural'))
            ->emptyStateDescription(__('admin/_shell.common.empty_states.eggs'));
    }
