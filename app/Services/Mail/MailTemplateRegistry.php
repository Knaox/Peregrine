    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'description' => 'Sent when a server is suspended after a Stripe subscription cancellation. Includes the date of hard deletion (after the configured grace period) and a link to the Stripe Customer Portal so the user can reactivate their subscription.',
                'variables' => ['name', 'plan_name', 'server_name', 'scheduled_deletion_at', 'panel_url', 'billing_portal_url', 'timestamp'],
