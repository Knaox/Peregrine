    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'variables' => ['name', 'plan_name', 'server_name', 'ip_port', 'reset_password_url', 'panel_url', 'timestamp'],
            ...
            [
                ...
                'variables' => ['name', 'plan_name', 'server_name', 'ip_port', 'panel_url', 'timestamp'],
                'default_subject_en' => 'Your {plan_name} server is ready',
                'default_subject_fr' => 'Votre serveur {plan_name} est prêt',
            ...
            [
                ...
                'description' => 'Sent when a server is suspended after a Stripe subscription cancellation. Includes the date of hard deletion (after the configured grace period).',
                'variables' => ['name', 'plan_name', 'server_name', 'scheduled_deletion_at', 'panel_url', 'timestamp'],
