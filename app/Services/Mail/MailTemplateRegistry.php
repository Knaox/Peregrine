    ...
    public static function all(): array
    {
        return [
            [
                ...
                'group' => 'Auth',
                'label' => __('admin/email_templates.registry.two_factor_enabled.label'),
                'description' => __('admin/email_templates.registry.two_factor_enabled.description'),
            ...
            [
                ...
                'group' => 'Auth',
                'label' => __('admin/email_templates.registry.two_factor_disabled.label'),
                'description' => __('admin/email_templates.registry.two_factor_disabled.description'),
                'variables' => ['name', 'server_name', 'timestamp', 'ip', 'user_agent', 'manage_url'],
            ...
            [
                ...
                'group' => 'Auth',
                'label' => __('admin/email_templates.registry.recovery_regenerated.label'),
                'description' => __('admin/email_templates.registry.recovery_regenerated.description'),
                'variables' => ['name', 'server_name', 'timestamp', 'ip', 'user_agent', 'manage_url'],
            ...
            [
                ...
                'group' => 'Auth',
                'label' => __('admin/email_templates.registry.oauth_linked.label'),
                'description' => __('admin/email_templates.registry.oauth_linked.description'),
            ...
            [
                ...
                'group' => 'Auth',
                'label' => __('admin/email_templates.registry.oauth_unlinked.label'),
                'description' => __('admin/email_templates.registry.oauth_unlinked.description'),
                'variables' => ['name', 'provider', 'server_name', 'timestamp', 'ip', 'user_agent', 'manage_url'],
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.payment_confirmed.label'),
                'description' => __('admin/email_templates.registry.payment_confirmed.description'),
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.server_ready_local.label'),
                'description' => __('admin/email_templates.registry.server_ready_local.description'),
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.server_ready_oauth.label'),
                'description' => __('admin/email_templates.registry.server_ready_oauth.description'),
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.server_reactivated.label'),
                'description' => __('admin/email_templates.registry.server_reactivated.description'),
                'variables' => ['name', 'plan_name', 'server_name', 'ip_port', 'panel_url', 'login_url', 'timestamp'],
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.server_suspended.label'),
                'description' => __('admin/email_templates.registry.server_suspended.description'),
            ...
            [
                ...
                'group' => 'Bridge',
                'label' => __('admin/email_templates.registry.trial_will_end.label'),
                'description' => __('admin/email_templates.registry.trial_will_end.description'),
